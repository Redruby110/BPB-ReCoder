...
<h2>اول</h2> 
 ...
 <h3>کد های اصلی و خام پروژه BPB را در باکس اول وارد کنید:</h3>

<img src="doc/1.png" width="100%">

<h1>دریافت کد های پروژه: 
...
<h3>وارد کردن اطلاعات ورود به پنل (اجباری 😱)</h3>
<p>
📝 فقط از کلمات کوچک انگیسی
<br>
<b>باکس هایی که باز هستند وارد کردن اطلاعات اجباری می باشد و باکس هایی که پیشفرض بسته هستند مثل (صفحه اصلي) یا (توابع فرعي) میتوانید خالی بگزارید</b>
